...
export function summary(eventId) {
  ...
  return {
    ...
    drives: { current: { team: { id: h.team.id }, offensivePlays: 6, yards: 54, timeElapsed: { displayValue: '2:51' }, plays: [{ id: 'p1', text: 'Rush middle for 3 yards', type: { text: 'Rush' }, statYardage: 3, start: { team: { id: h.team.id }, yardsToEndzone: 60 }, end: { team: { id: h.team.id }, yardsToEndzone: 57 } }, { id: 'p2', text: 'D. Moore pass complete to E. Stewart for 26 yards to the ' + a.team.abbreviation + ' 31, 1ST DOWN', type: { text: 'Pass Reception' }, statYardage: 26, start: { team: { id: h.team.id }, yardsToEndzone: 57, down: 2, distance: 7 }, end: { team: { id: h.team.id }, yardsToEndzone: 31, down: 1, distance: 10, shortDownDistanceText: '1st & 10', possessionText: a.team.abbreviation + ' 31' } }] } },
